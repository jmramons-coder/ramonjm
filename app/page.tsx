...
const projects = [
  ...
  { name: "Tracer", slug: "tracer", image: "/tracer/logo-glass.png", detail: "A clearer path to great science.", discipline: "Brand & website" },
  { name: "aBeam", slug: "abeam", image: "/abeam/mark.png", detail: "Conversations, organized.", discipline: "AI product concept" },
