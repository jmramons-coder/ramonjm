...
export default async function Study({searchParams}:{searchParams:Promise<{error?:string}>}) {
 ...
 return <>{access && <SiteHeader textOnly backHref="/#explorations" backLabel="Back to portfolio" />}<ScrollBackground hasFooter={access} /><main className={styles.page} id="main-content">
